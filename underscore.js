...
(function() {
  ...
  _.asyncSortBy = function (arr, iterator, callback) {
    _.asyncMap(arr, function (x, callback) {
      ...
      if (err) {
        ...
        callback(null, _.map(results.sort(fn), function (x) {
          return x.value;
        }));
      }
    });
  ...
  _.parallel = function (tasks, callback) {
    ...
    if (tasks.constructor === Array) {
      _.asyncMap(tasks, function (fn, callback) {
        if (fn) {
          fn(function (err) {
      ...
      var results = {};
      _.asyncForEach(_.keys(tasks), function (k, callback) {
  ...
  _.series = function (tasks, callback) {
    callback = callback || function () {};
    if (tasks.constructor === Array) {
      _.asyncMapSeries(tasks, function (fn, callback) {
        if (fn) {
          fn(function (err) {
            var args = Array.prototype.slice.call(arguments, 1);
            if (args.length <= 1) {
      ...
      var results = {};
      _.asyncForEachSeries(_.keys(tasks), function (k, callback) {
        tasks[k](function (err) {
          var args = Array.prototype.slice.call(arguments, 1);
          if (args.length <= 1) {
            args = args[0];
