...
//     added functions: _.sum() _.mean() _.median() _.nrange()
...
(function() {
  ...
  _.sum = function(obj, iterator, context) {
  ...
  _.mean = function(obj, iterator, context) {
    if (!iterator && _.isEmpty(obj)) return Infinity;
  ...
  _.median = function(obj, iterator, context) {
  ...
  _.nrange = function(start, stop, step) {
    if (arguments.length <= 1) {
      if (start === 0)
        return [];
      stop = start || 0;
