$(document).ready(function() {
  ...
  test("objects: extend", function() {
    ...
    same(_.extend({x:'x', a:{b:'c'}}, { a: { d: 'e' } }).a, {b:'c', d:'e'}, 'Extend object recursively when source property is a hash');
    same(_.extend({x:'x'}, { a: { b: 'c' } }).a, {b:'c'}, 'Extend object recursively when destination does not exist');
  });
